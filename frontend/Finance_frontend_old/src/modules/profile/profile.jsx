...
import {
  getStorageSum,
  getBalanceToTarget,
  getBalanceToTargetinPercent,
} from "../../helpers/storageFunctions"
import MainFieldRouter from "../../pages/routePage/MainFieldRouter"
...
function Profile() {
  ...
  const selectDate =
    (dataCal && dataCal.split(".").reverse().join("-")) || currentDate
  //
  ...
  function getBalanceData() {
    ...
    fetch(
      ...
      .then((result) => result.json())
      .then((responseServer) =>
        setBalanceData(Number(responseServer.sum_balance).toFixed(2))
      )
  }
